...
from app.accounts.views import CustomLoginView, custom_logout, RegisterView
...
urlpatterns = [
    ...
    path('register/', RegisterView.as_view(template_name = 'accounts/register_account.html'), name='register'),
